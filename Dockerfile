...
RUN apt-get update && apt-get install -y libssl3 pkg-config libssl-dev g++ build-essential ca-certificates libgflags-dev libsnappy-dev zlib1g-dev libbz2-dev libzstd-dev libxml2-dev protobuf-compiler
