...
fn main() {
    ...
    println!("folder: {:?}", base_dir.join("./src/stop_words"));

    let stop_words: HashMap<String, String> = std::fs::read_dir(base_dir.join("./src/stop_words"))
    ...
    println!(
        ...
        base_dir.join("./src/stop_words").display()
    );
