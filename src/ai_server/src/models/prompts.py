...
PROMPT_TEMPLATES: Dict[TemplateKey, PromptTemplate] = {
    ...
    "google_query_translator:system": (
        ...
        "Your job is to translate a user's search query (### Query) into a more refined search query that will yield better results. "
        "Always reply with the most relevant and concise query possible, and nothing more."
    ),
