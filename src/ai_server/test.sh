...
grpcurl -plaintext -d '{ "input": "I would like to buy some skateboarding shoes.", "collection_id": "nike-data", "conversation": [] }' localhost:50051 orama_ai_service.LLMService/PlannedAnswer