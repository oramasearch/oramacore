...
grpcurl -plaintext -d '{ "input": "I need a pair of shoes that are good for a wedding, but also for a casual setting. I think I also need a pair of trousers to combine with them.", "collection_id": "nike-data", "conversation": [] }' localhost:50051 orama_ai_service.LLMService/PlannedAnswer