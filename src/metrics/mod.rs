...
pub mod embedding {
    ...
    create_time_histogram!(EMBEDDING_CALCULATION_TIME, "embedding_calculation_time_sec", EmbeddingCalculationLabels);
    create_counter_histogram!(EMBEDDING_CALCULATION_PARALLEL_COUNT, "embedding_calculation_batch_size", EmbeddingCalculationLabels);
}

pub mod document_insertion {
    use crate::create_time_histogram;
    use super::{FieldCalculationLabels, CollectionLabels};
    create_time_histogram!(FIELD_CALCULATION_TIME, "writer_field_calculation_time_sec", FieldCalculationLabels);
    create_time_histogram!(DOCUMENT_CALCULATION_TIME, "writer_doc_calculation_time_sec", CollectionLabels);
}

pub mod commit {
    use crate::create_time_histogram;
    use super::{CollectionCommitLabels, CollectionFieldCommitLabels, Empty};
    create_time_histogram!(COMMIT_CALCULATION_TIME, "commit_calculation_time_sec", CollectionCommitLabels);
    create_time_histogram!(FIELD_COMMIT_CALCULATION_TIME, "field_commit_calculation_time_sec", CollectionFieldCommitLabels);
    create_time_histogram!(DOCUMENT_COMMIT_CALCULATION_TIME, "document_commit_calculation_time_sec", Empty);
}
...
pub mod search {
    ...
    create_time_histogram!(SEARCH_CALCULATION_TIME, "search_calculation_time_sec", SearchCollectionLabels);
    create_time_histogram!(FILTER_CALCULATION_TIME, "filter_calculation_time_sec", CollectionLabels);
    create_counter_histogram!(FILTER_PERC_CALCULATION_COUNT, "filter_percentage_calculation_count", CollectionLabels);
    create_counter_histogram!(FILTER_COUNT_CALCULATION_COUNT, "filter_count_calculation_count", CollectionLabels);
    create_counter_histogram!(MATCHING_PERC_CALCULATION_COUNT, "matching_percentage_calculation_count", CollectionLabels);
    create_counter_histogram!(MATCHING_COUNT_CALCULTATION_COUNT, "matching_calculation_count", CollectionLabels);
}

pub mod rabbit {
    use crate::create_time_histogram;
    use super::Empty;
    create_time_histogram!(RABBITMQ_ENQUEUE_CALCULATION_TIME, "rabbitmq_enqueue_calculation_time_sec", Empty);
}

pub mod js {
    use crate::create_time_histogram;
    use super::JSOperationLabels;
    create_time_histogram!(JS_CALCULATION_TIME, "js_calculation_time_sec", JSOperationLabels);
}

impl Into<SharedString> for FieldId {
